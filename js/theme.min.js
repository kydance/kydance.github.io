(() => {
  ...
  // ns-hugo-imp:/Users/kyden/git-space/kyden.blog/assets/js/util.js
  var Util;
  var init_util = __esm({
    "ns-hugo-imp:/Users/kyden/git-space/kyden.blog/assets/js/util.js"() {
      Util = class {
      ...
      var FixIt = class {
        ...
        initTypeit(target = document) {
          if (this.config.typeit) {
            ...
            const stagingDOM2 = this.util.getStagingDOM();
            Object.values(groupMap).forEach((group) => {
              const typeone = (i) => {
                const typeitElement = group[i];
                const singleData = typeitElement.dataset;
                stagingDOM2.stage(typeitElement.querySelector("template").content.cloneNode(true));
                ...
                const instance = new TypeIt(targetEle, {
                  strings: stagingDOM2.$el.querySelector("pre")?.innerHTML || stagingDOM2.contentAsHtml(),
